...
export const cellectivepresse: FLink[] = [
    {
        text: "Die Glocke",
    ...
    {
        text: "Tagesschau",
        linktitle: "Tagesschau - Bielefelder Studierende forschen an neuer Brustkrebs-Therapie",
        img: newspaperImg,
    ...
    {
        linktitle: "WDR - Neue Therapie gegen aggressiven Brustkrebs aus Bielefeld",
        text: "WDR",
        img: newspaperImg,
